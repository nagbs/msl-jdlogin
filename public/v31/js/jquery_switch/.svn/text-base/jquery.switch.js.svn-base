     ...
     /* $select.bind('change', function() {
      ...
      $switch.bind('switch:slideon', function() {
        ...
        $master.stop().animate({ left: masterOn }, 'fast', function() {        	
          $switch.data('animating', false).data('select').val(values.on).trigger('change');         
      ...
      $switch.bind('switch:slideoff', function() {
        ...
        $master.stop().animate({ left: masterOff }, 'fast', function() {
          $switch.data('animating', false).data('select').val(values.off).trigger('change');
	  ...
	  {
		  $handle.hide();		  
		  $switch.find('.ui-switch-labels > a').css({width:'28px'});
