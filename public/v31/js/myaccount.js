...
$('#addMore').click(function()
		{  
			...
			$("#emailContainer").append('<div class="m-block"><div class="btnWhite remove" style="margin-top:12px;margin-right:10px;"><a href="#"><img src="/images/dust-bin.png" title="REMOVE"></a></div></div>');
