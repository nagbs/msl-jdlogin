		...
		$("#41").append($(option3));
			...
			if(selected_val!='' && selected_val!='--Select--' && selected_val!=null)
			{
				...
				type = $("#ord_form div[order_type='"+ord_type+"'] [name='Type"+version_val+"']").val();
						...
						$.post('/orders/configureddeliveries/',{'site':site, 'ord_type' : ord_type, 'product': parent_product_val, 'type' : type, 'output_type': output_type, 'request_filed':request_filed}, function(data){
