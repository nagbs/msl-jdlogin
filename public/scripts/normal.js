...
var gcCalBG="#669933";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#9acd32";	// the background color of the inner table, showing as a frame.
...
var gcCellBG="#f1f8de";	// default background color of the cells. Use "" for transparent!!!
...
var gcSatBG="#f1f8de";	// Saturday background color
var gcSun="black";	// Sunday font color
var gcSunBG="#f1f8de";	// Sunday background color

var gcOtherDay="#669933";	// the font color of days in other months; It's of no use when giShowOther is set to hide.
