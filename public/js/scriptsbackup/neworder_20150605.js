			...
			{				
...

				{
...

					{
						...
						//alert(width+'<>'+width_uom+'<>'+depth+'<>'+depth_uom);
...
$("[name='Proof Date']").css('background-color','');
$("[name='Run Date']").css('background-color','');
$("[name='Publish Date']").css('background-color','');

if($("[name='Proof Date']").val() == '' || (!DateRegExp.test($("[name='Proof Date']").val())))
{
		$("#msgbox_text").html("<div><br/>Please enter a Valid Date! <br/><br/>" +
		"					<img id='create_ok' src='/images/ok.gif' style='vertical-align:middle;' /></div>");
		$("#msgbox").fadeIn('fast',function(){
			$("#msgbox_table").css('width','350px');
			$("#msgbox").css('display','table');
			$("#create_ok").click(function(){
				$("#msgbox").fadeOut('fast');
				$("[name='Proof Date']").css('background-color','#FF0000');
			});
		});
		return false;
}

if($("[name='Run Date']").val() == '' || (!DateRegExp.test($("[name='Run Date']").val())))
{
		$("#msgbox_text").html("<div><br/>Please enter a Valid Date! <br/><br/>" +
		"					<img id='create_ok' src='/images/ok.gif' style='vertical-align:middle;' /></div>");
		$("#msgbox").fadeIn('fast',function(){
			...
			$("#create_ok").click(function(){
				$("#msgbox").fadeOut('fast');
				$("[name='Run Date']").css('background-color','#FF0000');
			});
		});
		return false;
}

if($("[name='Publish Date']").val()!= '' && (!DateRegExp.test($("[name='Publish Date']").val())))
{	
	$("#msgbox_text").html("<div><br/>Please enter a Valid Date! <br/><br/>" +
	"					<img id='create_ok' src='/images/ok.gif' style='vertical-align:middle;' /></div>");
	$("#msgbox").fadeIn('fast',function(){
		...
		$("#create_ok").click(function(){
			$("#msgbox").fadeOut('fast');
			$("[name='Publish Date']").css('background-color','#FF0000');
		});
	});
	return false;
}
...
if($('#Print').attr('checked')) 
{
	...
	$("[name='Width']").css('background-color','');
	$("[name='Depth']").css('background-color','');
	
	if(!NumRegExp.test($("[name='Width']").val()))
	{
		$("#msgbox_text").html("<div><br/>Characters not allowed!<br/><br/>" +
		"					<img id='create_ok' src='/images/ok.gif' style='vertical-align:middle;' /></div>");
		$("#msgbox").fadeIn('fast',function(){
			$("#msgbox_table").css('width','350px');
			$("#msgbox").css('display','table');
			$("#create_ok").click(function(){
				$("#msgbox").fadeOut('fast');
				$("[name='Width']").css('background-color','#FF0000');
			});
		});
		return false;
	}
	else if(!NumRegExp.test($("[name='Depth']").val()))
	{
		$("#msgbox_text").html("<div><br/>Characters not allowed <br/><br/>" +
		"					<img id='create_ok' src='/images/ok.gif' style='vertical-align:middle;' /></div>");
		$("#msgbox").fadeIn('fast',function(){
			...
			$("#create_ok").click(function(){
				$("#msgbox").fadeOut('fast');
				$("[name='Depth']").css('background-color','#FF0000');
			});
		});
		return false;
	}
