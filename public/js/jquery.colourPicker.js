...
jQuery.fn.colourPicker = function (conf) {
	...
	var hexInvert = function (hex) {
		...
		return 0.212671 * r + 0.715160 * g + 0.072169 * b < 0.5 ? 'ffffff' : 'ffffff'
	};
	...
	return this.each(function () {
		...
		var icon	= jQuery('<a href="#" class="ici"><img style="vertical-align:text-bottom;" src="' + config.ico + '" alt="' + config.openTxt + '" /></a>').insertAfter(select);
